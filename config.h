...
/* Build date and time */
#define BUILD_DATE "2026-02-28T18:22:32Z"
...
#define LLDPD_CTL_SOCKET "/usr/var/run/lldpd.socket"

/* Path to lldpd PID file */
#define LLDPD_PID_FILE "/usr/var/run/lldpd.pid"

/* C compiler command */
#define LLDP_CC "gcc  -fdiagnostics-show-option -fdiagnostics-color=auto -fno-omit-frame-pointer -funsigned-char -pipe -Wall -W -Wextra -Wformat -Wformat-security -Wimplicit-fallthrough -Wfatal-errors -Winline -Wpointer-arith -Wmissing-prototypes -Wno-cast-align -Wno-unused-parameter -Wno-missing-field-initializers -Wno-sign-compare -fstack-protector -fstack-protector-all -fstack-protector-strong -fstack-clash-protection  -D_FORTIFY_SOURCE=2 -D_GNU_SOURCE -g -O2 "
...
#define PACKAGE_BUGREPORT "https://github.com/lldpd/lldpd/issues"

/* Define to the full name of this package. */
#define PACKAGE_NAME "lldpd"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "lldpd a3bfd10-dirty"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "lldpd"

/* Define to the home page for this package. */
#define PACKAGE_URL "https://lldpd.github.io/"

/* Define to the version of this package. */
#define PACKAGE_VERSION "a3bfd10-dirty"

/* Which directory to use to chroot lldpd */
#define PRIVSEP_CHROOT "/usr/var/run/lldpd"
...
#define SYSTEMDSYSTEMUNITDIR "/usr/lib/systemd/system"

/* Directory for sysusers files */
#define SYSUSERSDIR "/usr/lib/sysusers.d"
